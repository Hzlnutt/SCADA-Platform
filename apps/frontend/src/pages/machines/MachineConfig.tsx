    ...
    return (
      <div className="space-y-6">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 text-center text-sm text-slate-500 shadow-sm">
          ...
          <p>Anda tidak memiliki izin untuk melihat atau mengubah Konfigurasi unit ini. Halaman ini hanya dapat diakses oleh Unit Head, Senior Unit Head, dan Admin.</p>
        </div>
      </div>
    );
  }
