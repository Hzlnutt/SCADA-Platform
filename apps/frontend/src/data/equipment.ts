...
export const DEFAULT_CT1_EQ_CONFIGS: ConfigEqRow[] = [
  ...
  { tagKey: "F1_MOTOR_OVERHAUL", tagName: "F-1 Direct Drive Motor Overhaul", baseline: 8900, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "ON" },
  ...
  { tagKey: "M1_PUMP_MOTOR_OVERHAUL", tagName: "M-1 Pump Motor Overhaul/Bearing", baseline: 2100, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "OFF" },
  { tagKey: "M2_SUPPLY_MOTOR_OVERHAUL", tagName: "M-2 Supply Motor 1 Overhaul/Bearing", baseline: 542, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "OFF" },
  { tagKey: "M3_SUPPLY_MOTOR_OVERHAUL", tagName: "M-3 Supply Motor 2 Overhaul/Bearing", baseline: 437, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "ON" },
...
export const DEFAULT_CT2_EQ_CONFIGS: ConfigEqRow[] = [
  ...
  { tagKey: "F2_MOTOR_OVERHAUL", tagName: "F-2 Direct Drive Motor Overhaul", baseline: 3870, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "ON" },
  ...
  { tagKey: "M4_PUMP_MOTOR_OVERHAUL", tagName: "M-4 Pump Motor Overhaul/Bearing", baseline: 3870, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "ON" },
  { tagKey: "M5_SUPPLY_MOTOR_OVERHAUL", tagName: "M-5 Supply Motor 3 Overhaul/Bearing", baseline: 2080, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "ON" },
  { tagKey: "M6_SUPPLY_MOTOR_OVERHAUL", tagName: "M-6 Supply Motor 4 Overhaul/Bearing", baseline: 3470, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "OFF" },
...
export const DEFAULT_CT3_EQ_CONFIGS: ConfigEqRow[] = [
  ...
  { tagKey: "F3_MOTOR_OVERHAUL", tagName: "F-3 Direct Drive Motor Overhaul", baseline: 2980, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "ON" },
  ...
  { tagKey: "M7_PUMP_MOTOR_OVERHAUL", tagName: "M-7 Pump Motor Overhaul/Bearing", baseline: 2980, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "OFF" },
  { tagKey: "M8_SUPPLY_MOTOR_OVERHAUL", tagName: "M-8 Supply Motor 5 Overhaul/Bearing", baseline: 5030, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "ON" },
  { tagKey: "M9_SUPPLY_MOTOR_OVERHAUL", tagName: "M-9 Supply Motor 6 Overhaul/Bearing", baseline: 6890, lowLimit: 0, highLimit: 10000, unit: "h", enableAlert: true, suppressAlert: false, status: "ON" },
